...
static void btn_rescan_mac_cb(lv_event_t * e) { playToneI2S(800, 100, true); if (bleMutex != NULL && xSemaphoreTake(bleMutex, pdMS_TO_TICKS(50)) == pdTRUE) { scanResultCount = 0; strcpy(scanOptionsStr, "Suche laeuft..."); xSemaphoreGive(bleMutex); }
